  ...
  return (
    <>
      {isMealPlanTeaserEnabled(userId) ? (
        <motion.section {...fadeInUp} aria-label="Meal ideas">
      ...
      {isProteinHintStripEnabled(userId) && proteinHint ? (
        <motion.section {...fadeInUp} aria-label="Protein hint">
          <div className="rounded-xl border border-sky-600/30 bg-sky-950/30 px-3 py-2 text-xs text-sky-100">
      ...
      {isSleepWeekCardEnabled(userId) && sleepAvg != null ? (
        <motion.section {...fadeInUp} aria-label="Sleep average">
      ...
      {isProValueStripEnabled(userId) ? (
        <motion.section {...fadeInUp} aria-label="Pro value">
      ...
      {isReferralInviteEnabled(userId) ? (
        <motion.section {...fadeInUp} aria-label="Refer a friend">
      ...
      {isYearReviewPageEnabled(userId) ? (
        <motion.section {...fadeInUp} aria-label="Year in review">
